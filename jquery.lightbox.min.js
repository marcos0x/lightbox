...
c);a.open();return!1})};a.open=function(){c("html,body").addClass("no-scroll");c("body").append(a.settings.box);a.settings.classes&&a.settings.box.addClass(a.settings.classes);a.settings.box.css("visibility","hidden");a.settings.box.css("display","block");a.setPosition();a.settings.box.css("display","none");a.settings.box.css("visibility","visible");a.settings.box.fadeIn(450)};a.close=function(){c("html,body").removeClass("no-scroll");a.settings.box.fadeOut(450,function(){a.settings.box.remove()})}};
